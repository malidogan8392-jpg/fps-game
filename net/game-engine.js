...
window.MAPS = {
    ...
    castle:  { name: 'Kale', theme: 'grass', size: 40, model: { url: 'public/models/castle.glb', scale: 1, rotY: 0, offsetY: 0 } },
    castle_arena:  { name: 'Kale Arenası', theme: 'grass', size: 100, model: { url: 'public/models/fps_map_warface_big_castle_pvp_pve.glb', scale: 1, rotY: 0, offsetY: 0 } },
    neon_grand:    { name: 'Neon Kompleks', theme: 'urban', size: 110, model: { url: 'public/models/a_very_beautiful_neon_fps_pvp_map.glb', scale: 1, rotY: 0, offsetY: 0 } },
    warehouse:     { name: 'Depo', theme: 'industrial', size: 65, model: { url: 'public/models/fps_pvp_map_and_pve.glb', scale: 1, rotY: 0, offsetY: 0 } },
    district:      { name: 'Bölge', theme: 'urban', size: 55, model: { url: 'public/models/pvp_map_xxxl_big_fps_pve.glb', scale: 1, rotY: 0, offsetY: 0 } },
    outpost:       { name: 'Karakol', theme: 'urban', size: 24, model: { url: 'public/models/fps_map.glb', scale: 1, rotY: 0, offsetY: 0 } },
    outpost_neon:  { name: 'Neon Karakol', theme: 'urban', size: 24, model: { url: 'public/models/fps_map_pvppve_neon.glb', scale: 1, rotY: 0, offsetY: 0 } },
    complex:       { name: 'Kompleks', theme: 'industrial', size: 40, model: { url: 'public/models/fps_map_pvp_pve_games.glb', scale: 1, rotY: 0, offsetY: 0 } },
    facility:      { name: 'Tesis', theme: 'industrial', size: 38, model: { url: 'public/models/pvp_map_fps.glb', scale: 1, rotY: 0, offsetY: 0 } },
    shatterline:   { name: 'Shatterline', theme: 'industrial', size: 18, model: { url: 'public/models/fps_map_pvp_shatterline_neon_3x3.glb', scale: 1, rotY: 0, offsetY: 0 } },
    neon_arena:    { name: 'Neon Arena', theme: 'urban', size: 22, model: { url: 'public/models/fps_map_pvp_pve_game_neon.glb', scale: 1, rotY: 0, offsetY: 0 } },
    ruins:         { name: 'Yıkıntı', theme: 'industrial', size: 30, model: { url: 'public/models/fps_warface_map_destruction_pvp_shuret_neon.glb', scale: 1, rotY: 0, offsetY: 0 } },
    freezone:      { name: 'Serbest Bölge', theme: 'urban', size: 22, model: { url: 'public/models/free_map_pvp_fps_neon.glb', scale: 1, rotY: 0, offsetY: 0 } },
    sector:        { name: 'Sektör', theme: 'urban', size: 18, model: { url: 'public/models/fps_warface_map_neon_pvp_pve.glb', scale: 1, rotY: 0, offsetY: 0 } },
    crossing:      { name: 'Kavşak', theme: 'urban', size: 70, model: { url: 'public/models/city_scene.glb', scale: 1, rotY: 0, offsetY: 0 } },
    labyrinth:     { name: 'Labirent', theme: 'industrial', size: 45, model: { url: 'public/models/labyrinth.glb', scale: 1, rotY: 0, offsetY: 0 } },
    warship:       { name: 'Savaş Gemisi', theme: 'harbor', size: 50, model: { url: 'public/models/warship.glb', scale: 1, rotY: 0, offsetY: 0 } }
};
