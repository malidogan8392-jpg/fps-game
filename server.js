...
harbor: {
  ...
  castle: {
    ...
    model: { url:'/models/castle.glb', scale:0.3, offsetY:0.3, rotY:0 },
    walls: [
  ...
  city2: {
    ...
    model: { url:'/models/city_scene.glb', scale:0.0095, offsetY:0, rotY:0 },
    walls: [
  ...
  labyrinth: {
    ...
    model: { url:'/models/labyrinth.glb', scale:1.2, offsetY:0, rotY:0 },
    walls: [
  ...
  warship: {
    ...
    model: { url:'/models/warship.glb', scale:0.034, offsetY:-10.54, rotY:0 },
    walls: [
