...
module.exports = function(io) {
    ...
    async function flushAccountsToGithub() {
        ...
        try {
            ...
            if (res.status === 200 || res.status === 201) {
                ...
                // sha uyuşmuyor ya da bilinmiyor (409) / dosya zaten var ama sha eksik (422):
                // güncel sha'yı çekip bir sonraki flush'ta tekrar dene
    ...
    const MAPS = {
        ...
        castle_arena: {
            name: 'Kale Arenası', theme: 'grass', size: 100,
            model: { url: '/castle_arena.glb', scale: 1, rotY: 0, offsetY: 0 }
        },
        neon_grand: {
            name: 'Neon Kompleks', theme: 'urban', size: 110,
            model: { url: '/neon_grand.glb', scale: 1, rotY: 0, offsetY: 0 }
        },
        warehouse: {
            name: 'Depo', theme: 'industrial', size: 65,
            model: { url: '/warehouse.glb', scale: 1, rotY: 0, offsetY: 0 }
        },
        district: {
            name: 'Bölge', theme: 'urban', size: 55,
            model: { url: '/district.glb', scale: 1, rotY: 0, offsetY: 0 }
        },
        outpost: {
            name: 'Karakol', theme: 'urban', size: 24,
            model: { url: '/outpost.glb', scale: 1, rotY: 0, offsetY: 0 }
        },
        outpost_neon: {
            name: 'Neon Karakol', theme: 'urban', size: 24,
            model: { url: '/outpost_neon.glb', scale: 1, rotY: 0, offsetY: 0 }
        },
        complex: {
            name: 'Kompleks', theme: 'industrial', size: 40,
            model: { url: '/complex.glb', scale: 1, rotY: 0, offsetY: 0 }
        },
        facility: {
            name: 'Tesis', theme: 'industrial', size: 38,
            model: { url: '/facility.glb', scale: 1, rotY: 0, offsetY: 0 }
        },
        shatterline: {
            name: 'Shatterline', theme: 'industrial', size: 18,
            model: { url: '/shatterline.glb', scale: 1, rotY: 0, offsetY: 0 }
        },
        neon_arena: {
            name: 'Neon Arena', theme: 'urban', size: 22,
            model: { url: '/neon_arena.glb', scale: 1, rotY: 0, offsetY: 0 }
        },
        ruins: {
            name: 'Yıkıntı', theme: 'industrial', size: 30,
            model: { url: '/ruins.glb', scale: 1, rotY: 0, offsetY: 0 }
        },
        freezone: {
            name: 'Serbest Bölge', theme: 'urban', size: 22,
            model: { url: '/freezone.glb', scale: 1, rotY: 0, offsetY: 0 }
        },
        sector: {
            name: 'Sektör', theme: 'urban', size: 18,
            model: { url: '/sector.glb', scale: 1, rotY: 0, offsetY: 0 }
        },
        crossing: {
            name: 'Kavşak', theme: 'urban', size: 70,
            model: { url: '/crossing.glb', scale: 1, rotY: 0, offsetY: 0 }
        }
    };
    // NOT: model tabanlı haritaların scale/rotY/offsetY değerleri şimdilik 1/0/0.
    // Boyutlar (size) modellerin gerçek bounding box'ından hesaplandı ama
    // tam oturmayabilir — tarayıcıda test edip "çok büyük/küçük/kayık" derseniz
    // buradan map bazında ayarlanır. Bu haritalarda henüz collision (walls)
    // verisi yok; mermiler model geometrisini görsel olarak es geçer.
    ...
    function pickVoteChoices() {
        return Object.keys(MAPS); // tüm haritalar oylamaya sunulur
    }
